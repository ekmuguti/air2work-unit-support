...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 active:scale-[0.98]",
  {
    variants: {
      variant: {
        default:
          "bg-gradient-primary text-primary-foreground shadow-md hover:shadow-lg glow-primary hover:brightness-110",
        destructive:
          "bg-gradient-danger text-destructive-foreground shadow-md hover:shadow-lg glow-danger hover:brightness-110",
        outline:
        ...
        video:
          "bg-secondary/80 text-secondary-foreground border border-border hover:bg-primary/20 hover:border-primary/50 hover:text-primary",
      },
      size: {
